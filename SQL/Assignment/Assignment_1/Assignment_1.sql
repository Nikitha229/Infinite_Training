...
--Employees Table
create table Employees(Empno numeric(4) primary key,Ename varchar(20) not null,Job varchar(15),Salary numeric(7),Deptno numeric(2) , Foreign key (Deptno) references Departments(Deptno))
...
create table Projects(Project_ID numeric(3) primary key,Descr varchar(30) not null,Start_Date date,Planned_End_Date date,Actual_End_date date,Budget numeric(10),Client_ID numeric(4),foreign key (Client_id) references Clients(Client_Id))
...
create table EmpProjects(Project_ID numeric(3),Empno numeric(4) ,Start_Date date,End_Date date,Task varchar(25) not null,Status varchar(15) not null)

alter table EmpProjects add constraint fk_project foreign key (Project_ID) references Projects(Project_id)

alter table EmpProjects add constraint fk_Employee foreign key (Empno) references Employees(Empno)

insert into EmpProjects values(401,7001,'2011-04-01','2011-04-20','System Analysis','Completed'),

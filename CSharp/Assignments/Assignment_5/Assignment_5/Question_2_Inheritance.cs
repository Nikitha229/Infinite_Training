...
namespace Assignment_5
{
    ...
    {
        public Result(int rollno, string name, int sem, string branch, int section):base(rollno, name,sem, branch, section) { }
    ...
    class Question_2_Inheritance
    {
        public static void Main()
        {
            ...
            Result s1 = new Result(rollno, name, sem, branch, section);
            s1.GetMarks();

...
namespace Coding_Challenge_9_Question_1.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "fn_GetCustomer_info")]
        public virtual IQueryable<fn_GetCustomer_info_Result> fn_GetCustomer_info(string countryname)
        {
            var countrynameParameter = countryname != null ?
                new ObjectParameter("countryname", countryname) :
                new ObjectParameter("countryname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetCustomer_info_Result>("[NorthwindEntities].[fn_GetCustomer_info](@countryname)", countrynameParameter);
        }
